...
class GlProgram(val name: String, vs: String, fs: String) {
    ...
    val uEmissive = u("uEmissive"); val uLight = u("uLight"); val uTex = u("uTex"); val uHasTex = u("uHasTex"); val uTexScale = u("uTexScale"); val uWoodBoost = u("uWoodBoost"); val uActBoost = u("uActBoost")
